...
// // Atv1 - Escreva um programa que receba uma lista de números inteiros e
// retorne
// // uma lista contendo apenas os números pares usando a Stream API. A lista
// deve
...
// lista_dos_numeros = lista_dos_numeros.stream().filter(num -> num % 2 ==
// 0).toList();

// lista_dos_numeros.stream().forEach(num -> System.out.println(num));
// }

// // Atv2 - Dada a seguinte lista de nomes("roberto", "josé", "caio",
// "vinicius"),
// // escreva um programa que converta todos os nomes para letras maiúsculas
// usando
// // a Stream API.
...
// // Atv3 - Crie um programa que conte quantas vezes cada palavra única aparece
// em
// // uma lista de strings. Utilize a Stream API para processar os dados. Lista
// de
...
// // uma lista com 4 objetos do tipo Produto, pode definir os valores
// diretamente
...
// produtos.stream().filter(produto -> produto.getPreco() >
// 100).toList().forEach(produto -> {
...
// List<String> linguagens = new ArrayList<>(Arrays.asList("Java", "Python",
// "C", "JavaScript", "Ruby", "C++"));

// linguagens.stream().sorted((s1, s2) -> Integer.compare(s1.length(),
// s2.length()))
